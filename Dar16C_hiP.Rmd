...
Data <- subset(read.csv(file),subset = dataset=="Dar16C_hiP")
...
B9 <- predict(Modelo.9,which="line")[,c("line","predicted.values")]
names(B9) <- c("line","PHI")

all_effects <- list(B1,B2,B3,B4,B5,B6,B7,B8,B9)
...
<a href="datasets/BLUPs_Dar16C_hiP.csv" download="BLUPs_Dar16C_hiP"> Download BLUPs </a>
