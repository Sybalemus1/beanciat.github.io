...
Data <- subset(read.csv(file),subset = dataset=="Pal13C_drt")
Data <- droplevels(Data)
```


Traits in this trial. (O2N)
...
1. Other: 
      - Meters Harvested **(MEHA)** 
      - Meters Square Harvested **(MT2H)**
      - Total Seed Weight **(TSW)**
...
all_effects <- list(B1,B2,B3,B4,B5)
...
h = c("DPM" =  as.vector(h5),"DF" = as.vector(h4),
       "PLHA" = as.vector(h3),"YDHA" = as.vector(h2),
       "YDHPL" = as.vector(h1))
...
<a href="datasets/BLUPs_Pal13C_drt.csv" download="BLUPs_Pal13C_drt"> Download BLUPs </a>
