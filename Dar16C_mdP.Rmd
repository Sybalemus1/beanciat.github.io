...
Data <- subset(read.csv(file),subset = dataset=="Dar16C_mdP")
...
all_effects <- list(B1,B2,B3,B4,B7)
...
<a href="datasets/BLUPs_Dar16C_mdP.csv" download="BLUPs_Dar16C_mdP"> Download BLUPs </a>
