...
all_effects <- list(B1,B3,B6,B7,B8)
...
h = c("YDHPL" = as.vector(h1),
      "PLHA" = as.vector(h3),"SW100" =  as.vector(h6),
...
<a href="datasets/BLUPs_Pal15C_irr.csv" download="BLUPs_Pal15C_irr"> Download BLUPs </a>
