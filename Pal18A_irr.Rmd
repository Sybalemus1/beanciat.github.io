...
Data <- subset(read.csv(file),subset = dataset=="Pal18A_irr")
...
all_effects <- list(B1,B2,B3,B4,B6,B7,B8)
...
<a href="datasets/BLUPs_Pal18A_irr.csv" download="BLUPs_Pal18A_irr"> Download BLUPs </a>
