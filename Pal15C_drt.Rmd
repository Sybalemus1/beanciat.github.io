...
Data <- subset(read.csv(file),subset = dataset=="Pal15C_drt")
...
all_effects <- list(B1,B2,B3,B6,B7,B8)
...
<a href="datasets/BLUPs_Pal15C_drt.csv" download="BLUPs_Pal15C_drt"> Download BLUPs </a>
