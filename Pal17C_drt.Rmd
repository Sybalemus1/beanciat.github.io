...
Data <- subset(read.csv(file),subset = dataset=="Pal17C_drt")
...
all_effects <- list(B1,B3,B4,B6,B7,B8)
...
<a href="datasets/BLUPs_Pal17C_drt.csv" download="BLUPs_Pal17C_drt"> Download BLUPs </a>
